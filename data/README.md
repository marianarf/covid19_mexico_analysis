...
Aquí se mantienen los datos 🗂️ de fuentes oficiales en formato reproducible para facilitar el análisis del progreso de COVID-19 en México 🦠🇲🇽. Más info sobre las fuentes en otro repo: [marianarf/covid19_mexico_data](https://github.com/marianarf/covid19_mexico_data).
...
``'sinave/'``
Casos acumulados por entidad federativa proporcionado por la [SINAVE](https://covid19.sinave.gob.mx/graficasconfirmados.aspx).
